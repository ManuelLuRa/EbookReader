 ...
 */
public class LoginPersistor implements Persistor<DBLogin> {

    private DBHelper dbhelper;

    @Inject LoginPersistor (DBHelper dbHelper){
        this.dbhelper = dbHelper;
    }

    @Override
    public void persist(DBLogin data) throws SQLException {
        if(data != null) dbhelper.getLoginDao().create(data);
    }
}
