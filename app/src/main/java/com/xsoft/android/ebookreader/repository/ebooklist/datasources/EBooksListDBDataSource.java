 ...
 */
public interface EBooksListDBDataSource {
    Collection<EBook> getEBookCollection() throws CacheException;

    void persist(EBook eBook) throws PersistException;

    void delete(String eBookName) throws PersistException;
